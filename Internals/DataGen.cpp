...
Eigen::MatrixXd DataGen::MVData(std::mt19937& gen, const unsigned& T, const unsigned& N, const VectorXd& m, const Eigen::MatrixXd& S, const bool& corr, const double& beta_param)
{
    /* Dummies */
...
)
{
    ...
    Results.date = VectorXi::LinSpaced(X.rows(), 0, static_cast<Eigen::Index>(static_cast<int>(X.rows()) - 1));
