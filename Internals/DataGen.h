...
namespace DataGen {
    ...
    MatrixXd rndCorrMat(std::mt19937& gen, const double& beta_param = 1, const unsigned& N = 100);
    MatrixXd MVData(std::mt19937& gen, const unsigned& T, const unsigned& N, const Eigen::VectorXd& m, const Eigen::MatrixXd& S, const bool& corr = false, const double& beta_param = 1.0);
    MatrixXd MVData(std::mt19937& gen, const unsigned& T, const unsigned& N, const bool& corr = false, const double& beta_param = 1.0);
